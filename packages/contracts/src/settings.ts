...
export const ServerSettings = Schema.Struct({
  ...
  providers: Schema.Struct({
    ...
    cursor: GenericProviderSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
    opencode: GenericProviderSettings.pipe(Schema.withDecodingDefault(Effect.succeed({}))),
