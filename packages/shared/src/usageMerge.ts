 ...
 * most recently read summary claims a fingerprint; the rest have that
 * directory's buckets dropped. Environment ids break ties so the winner is
 * stable when summaries have the same read time.
 */
